      ...
      <div className="bg-white md:rounded-[32px] flex flex-col gap-12 py-16 px-[8vw] md:px-16 text-center">
        ...
        <div className="flex flex-col gap-4 xl:grid grid-cols-[1fr_2fr] grid-rows-[1fr_max-content]">
          <div className="h-full bg-background w-full rounded-3xl flex flex-col gap-4 row-span-2 py-8 px-10 text-left">
            <div>
              <span className="font-medium text-light xl:text-lg">25+</span>
              <h3 className="font-medium text-xl xl:text-2xl">
                Projects completed
              </h3>
            </div>
            <div>
              <span className="font-medium text-light xl:text-lg">10k+</span>
              <h3 className="font-medium text-xl xl:text-2xl">
                Online impressions
              </h3>
            </div>
            <div>
              <span className="font-medium text-light xl:text-lg">99</span>
              <h3 className="font-medium text-xl xl:text-2xl">
                Succesful campaings
              </h3>
            </div>
            <div>
              <span className="font-medium text-light xl:text-lg">100%</span>
              <h3 className="font-medium text-xl xl:text-2xl">
